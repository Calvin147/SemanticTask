'''What I find interesting abou the similarities: 
It is interesting to see that NLP recoginises that cat and monkey are both
animals, as well as an apple and banana are both fruit. It also associates
that a moneky eats a banana and thus creates a similarity there as well'''

'''The differences between the two models of 'sm' and 'md' are that md 
gives more details and finds more similarities while the simple is just that
simple. '''
